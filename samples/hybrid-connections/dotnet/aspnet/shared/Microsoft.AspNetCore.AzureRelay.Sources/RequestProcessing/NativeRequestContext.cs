...
namespace Microsoft.AspNetCore.AzureRelay.Internal
{
    internal unsafe class NativeRequestContext : IDisposable
    {
        ...
        internal string GetKnownHeader(AzureRelayRequestHeader header)
        {
        ...
        private string GetKnowHeaderHelper(AzureRelayRequestHeader header, long fixup, HttpApiTypes.HTTP_REQUEST* request)
        {
