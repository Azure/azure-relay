    ...
    internal partial class RequestHeaders
    {
        ...
        internal StringValues Accept
        {
            get
			{
			    if (!((_flag0 & 0x1u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Accept);
					if (nativeValue != null)
					{
						_Accept = nativeValue;
					}
        ...
        internal StringValues AcceptCharset
        {
            get
			{
			    if (!((_flag0 & 0x2u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.AcceptCharset);
					if (nativeValue != null)
					{
        ...
        internal StringValues AcceptEncoding
        {
            get
			{
			    if (!((_flag0 & 0x4u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.AcceptEncoding);
					if (nativeValue != null)
					{
        ...
        internal StringValues AcceptLanguage
        {
            get
			{
			    if (!((_flag0 & 0x8u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.AcceptLanguage);
					if (nativeValue != null)
					{
        ...
        internal StringValues Allow
        {
            get
			{
			    if (!((_flag0 & 0x10u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Allow);
					if (nativeValue != null)
					{
						_Allow = nativeValue;
					}
        ...
        internal StringValues Authorization
        {
            get
			{
			    if (!((_flag0 & 0x20u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Authorization);
					if (nativeValue != null)
					{
        ...
        internal StringValues CacheControl
        {
            get
			{
			    if (!((_flag0 & 0x40u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.CacheControl);
					if (nativeValue != null)
					{
        ...
        internal StringValues Connection
        {
            get
			{
			    if (!((_flag0 & 0x80u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Connection);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentEncoding
        {
            get
			{
			    if (!((_flag0 & 0x100u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentEncoding);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentLanguage
        {
            get
			{
			    if (!((_flag0 & 0x200u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentLanguage);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentLength
        {
            get
			{
			    if (!((_flag0 & 0x400u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentLength);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentLocation
        {
            get
			{
			    if (!((_flag0 & 0x800u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentLocation);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentMd5
        {
            get
			{
			    if (!((_flag0 & 0x1000u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentMd5);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentRange
        {
            get
			{
			    if (!((_flag0 & 0x2000u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentRange);
					if (nativeValue != null)
					{
        ...
        internal StringValues ContentType
        {
            get
			{
			    if (!((_flag0 & 0x4000u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ContentType);
					if (nativeValue != null)
					{
        ...
        internal StringValues Cookie
        {
            get
			{
			    if (!((_flag0 & 0x8000u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Cookie);
					if (nativeValue != null)
					{
						_Cookie = nativeValue;
					}
        ...
        internal StringValues Date
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Date);
					if (nativeValue != null)
					{
						_Date = nativeValue;
					}
        ...
        internal StringValues Expect
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Expect);
					if (nativeValue != null)
					{
						_Expect = nativeValue;
					}
        ...
        internal StringValues Expires
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Expires);
					if (nativeValue != null)
					{
        ...
        internal StringValues From
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.From);
					if (nativeValue != null)
					{
						_From = nativeValue;
					}
        ...
        internal StringValues Host
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Host);
					if (nativeValue != null)
					{
						_Host = nativeValue;
					}
        ...
        internal StringValues IfMatch
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.IfMatch);
					if (nativeValue != null)
					{
        ...
        internal StringValues IfModifiedSince
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.IfModifiedSince);
					if (nativeValue != null)
					{
        ...
        internal StringValues IfNoneMatch
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.IfNoneMatch);
					if (nativeValue != null)
					{
        ...
        internal StringValues IfRange
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.IfRange);
					if (nativeValue != null)
					{
        ...
        internal StringValues IfUnmodifiedSince
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.IfUnmodifiedSince);
					if (nativeValue != null)
					{
        ...
        internal StringValues KeepAlive
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.KeepAlive);
					if (nativeValue != null)
					{
        ...
        internal StringValues LastModified
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.LastModified);
					if (nativeValue != null)
					{
        ...
        internal StringValues MaxForwards
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.MaxForwards);
					if (nativeValue != null)
					{
        ...
        internal StringValues Pragma
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Pragma);
					if (nativeValue != null)
					{
						_Pragma = nativeValue;
					}
        ...
        internal StringValues ProxyAuthorization
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.ProxyAuthorization);
					if (nativeValue != null)
					{
        ...
        internal StringValues Range
        {
            get
			{
				...
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Range);
					if (nativeValue != null)
					{
						_Range = nativeValue;
					}
        ...
        internal StringValues Referer
        {
            get
			{
			    if (!((_flag1 & 0x1u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Referer);
					if (nativeValue != null)
					{
        ...
        internal StringValues Te
        {
            get
			{
			    if (!((_flag1 & 0x2u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Te);
					if (nativeValue != null)
					{
						_Te = nativeValue;
					}
        ...
        internal StringValues Trailer
        {
            get
			{
			    if (!((_flag1 & 0x4u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Trailer);
					if (nativeValue != null)
					{
        ...
        internal StringValues TransferEncoding
        {
            get
			{
			    if (!((_flag1 & 0x8u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.TransferEncoding);
					if (nativeValue != null)
					{
        ...
        internal StringValues Translate
        {
            get
			{
			    if (!((_flag1 & 0x10u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Translate);
					if (nativeValue != null)
					{
        ...
        internal StringValues Upgrade
        {
            get
			{
			    if (!((_flag1 & 0x20u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Upgrade);
					if (nativeValue != null)
					{
        ...
        internal StringValues UserAgent
        {
            get
			{
			    if (!((_flag1 & 0x40u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.UserAgent);
					if (nativeValue != null)
					{
        ...
        internal StringValues Via
        {
            get
			{
			    if (!((_flag1 & 0x80u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Via);
					if (nativeValue != null)
					{
						_Via = nativeValue;
					}
        ...
        internal StringValues Warning
        {
            get
			{
			    if (!((_flag1 & 0x100u) != 0))
				{
					string nativeValue = GetKnownHeader(AzureRelayRequestHeader.Warning);
					if (nativeValue != null)
					{
