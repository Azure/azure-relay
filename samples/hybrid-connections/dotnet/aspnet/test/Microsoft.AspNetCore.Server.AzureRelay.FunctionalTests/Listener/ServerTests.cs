...
namespace Microsoft.Azure.Relay.AspNetCore.Listener
{
    public class ServerTests : IClassFixture<LaunchSettingsFixture>
    {
        ...
        {
            string address;
            using (var server = Utilities.CreateHttpServer(out address, Utilities.CreateTokenProvider()))
            {
...
#error Target framework needs to be updated
        ...
        public async Task Server_HotAddPrefix_Success()
        {
            ...
            using (var server = Utilities.CreateHttpServer(out address))
            {
                ...
                address += "pathbase/";
                server.Options.UrlPrefixes.Add(address, Utilities.CreateTokenProvider());
