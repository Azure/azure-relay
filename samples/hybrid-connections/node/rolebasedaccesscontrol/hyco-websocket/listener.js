...
openWebSocketListener(getTokenFunction);
...
async function openWebSocketListener(getTokenFunction) {
    const WebSocketServer = WebSocket.relayedServer;
    var websocketServer = new WebSocketServer(
        {
            server : WebSocket.createRelayListenUri(args.ns, args.path),
